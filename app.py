...
if st.session_state.mode == "main":
    ...
    # ---------- All Sections ----------
    with section_tabs[0]: setup_test("Practice", "Aptitude","Logical Reasoning", "Analytical Reasoning","Python", "DBMS")
    with section_tabs[1]: setup_test("Mock Interview", "Technical","HR","Manager", "Clint")
    with section_tabs[2]: setup_test("MCQ Quiz", "Data Structures","SQL", "Computer Networks",  "Operating System")
    with section_tabs[3]: setup_test("Code Runner", "Code Runner")
    with section_tabs[4]: setup_test("Pseudocode", "Pseudocode")
